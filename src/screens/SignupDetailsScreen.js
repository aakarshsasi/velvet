            ...
            <View style={styles.previewCard}>
              ...
              <View style={styles.previewContent}>
                <Text style={styles.previewText}>
                  <Text style={styles.previewHighlight}>{onboardingData.profile.persona}</Text> • 
                  <Text style={styles.previewHighlight}> {onboardingData.profile.desireLevel?.charAt(0).toUpperCase() + onboardingData.profile.desireLevel?.slice(1)}</Text> • 
                  <Text style={styles.previewHighlight}> {onboardingData.profile.relationshipStatus?.charAt(0).toUpperCase() + onboardingData.profile.relationshipStatus?.slice(1)}</Text>
                </Text>
              </View>
            </View>
          )}
          ...
          <View style={styles.formContainer}>
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.inputWithIcon}>
                <TextInput
                  ref={emailInputRef}
                  style={[styles.textInput, isEmailValid && styles.textInputValid]}
                  value={email}
            ...
            >
              ...
              >
                ...
                <Text style={styles.signUpButtonText}>
                  {isLoading ? 'Creating Your Account...' : 'Start My Velvet Journey 🚀'}
                </Text>
                <Text style={styles.signUpButtonSubtext}>
                  {isLoading ? 'Please wait...' : 'Unlock your personalized experience'}
                </Text>
              </LinearGradient>
            </TouchableOpacity>
