...
export default function DeckScreen() {
  ...
  const cardDecks = {
    'mild-seduction': [
      {
        id: 1,
        title: 'Whisper Compliments',
        description: 'Whisper three compliments into your partner\'s ear while maintaining eye contact.',
        difficulty: 'Easy',
        duration: '5 min',
        icon: '💭',
        color: '#FBBF24',
      },
      {
        id: 2,
        title: 'Arm Tracing',
        description: 'Gently trace your fingers along your partner\'s arm, starting from the wrist up to the shoulder.',
        difficulty: 'Easy',
        duration: '3 min',
        icon: '👆',
        color: '#F59E0B',
      },
      {
        ...
        description: 'Kiss your partner\'s hand slowly, lingering on each knuckle.',
        difficulty: 'Easy',
        duration: '5 min',
        icon: '💋',
        color: '#D97706',
      ...
      {
        id: 4,
        title: 'Seductive Gaze',
        description: 'Hold your partner\'s gaze for 30 seconds while smiling seductively.',
        difficulty: 'Easy',
        duration: '1 min',
        icon: '👀',
        color: '#FBBF24',
      },
      {
        id: 5,
        title: 'Cheek Whisper',
        description: 'Lightly brush your lips against your partner\'s cheek without fully kissing.',
        difficulty: 'Easy',
        duration: '2 min',
        icon: '💋',
        color: '#F59E0B',
      },
      {
        id: 6,
        title: 'Hair Play',
        description: 'Run your fingers through your partner\'s hair while telling them what you find attractive about them.',
        difficulty: 'Easy',
        duration: '5 min',
        icon: '💆',
        color: '#D97706',
      ...
      {
        id: 7,
        title: 'Forehead to Nose',
        description: 'Place a soft kiss on your partner\'s forehead, then trail down to their nose.',
        difficulty: 'Easy',
        duration: '3 min',
        icon: '💋',
        color: '#F472B6',
      },
      {
        id: 8,
        title: 'Behind Hug',
        description: 'Hug your partner from behind and whisper a secret desire.',
        difficulty: 'Easy',
        duration: '2 min',
        icon: '🤗',
        color: '#FBBF24',
      },
      {
        ...
        description: 'Gently massage your partner\'s shoulders for one minute.',
        difficulty: 'Easy',
        duration: '1 min',
        icon: '💆',
        color: '#D97706',
      },
      {
        id: 10,
        title: 'Neck to Ear',
        description: 'Kiss your partner\'s neck a few times and finish by sensually nibbling the lobe of the ear.',
        difficulty: 'Medium',
        duration: '5 min',
        icon: '👂',
        color: '#F59E0B',
      },
      {
        id: 11,
        title: 'Back Circles',
        description: 'Trace circles on your partner\'s back with your fingertips under their shirt.',
        difficulty: 'Medium',
        duration: '5 min',
        icon: '✨',
        color: '#8B5CF6',
      ...
      {
        id: 12,
        title: 'Scent Compliment',
        description: 'Compliment your partner\'s scent while leaning in close to their neck.',
        difficulty: 'Easy',
        duration: '2 min',
        icon: '🌸',
        color: '#F472B6',
      },
      {
        id: 13,
        title: 'Hand Hold',
        description: 'Hold hands and interlace fingers while staring into each other\'s eyes.',
        difficulty: 'Easy',
        duration: '3 min',
        icon: '🤝',
        color: '#FBBF24',
      },
      {
        id: 14,
        title: 'Neck Blow',
        description: 'Lightly blow on your partner\'s neck to create a tingling sensation.',
        difficulty: 'Easy',
        duration: '2 min',
        icon: '💨',
        color: '#F59E0B',
      },
      {
        id: 15,
        title: 'Skin Writing',
        description: 'Write a flirty note on your partner\'s skin with your finger.',
        difficulty: 'Easy',
        duration: '3 min',
        icon: '✍️',
        color: '#D97706',
